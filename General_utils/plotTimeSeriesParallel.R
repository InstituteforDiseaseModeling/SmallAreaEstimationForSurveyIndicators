...
#
#
# plotTimeSeriesParallel<-function(admin_level,
#                                  path_results,
#                                  figure_path,
#                                  FormattedData,
#                                  selected_models,
...
#     direct_data <- dplyr::filter(FormattedData, subgroup==selected_models$subgroup[ind])
#   }
#
...
#     mutate(direct_upper=outcome+qnorm(0.975)*SE,
...
#   registerDoSNOW(cl)
#   simdat = foreach(i=1:1,
#                    .packages=c("dplyr","stringr"),
#                    .export=c("expit","addTrans","loadRData"),
#                    .combine=rbind) %dopar%  plot_one(admin_level,
#                                                      path_results,
#                                                      figure_path,
#                                                      FormattedData,
#                                                      selected_models,
